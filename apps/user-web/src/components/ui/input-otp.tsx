...
>(({ char, hasFakeCaret, isActive, className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'relative flex h-11 w-11 items-center justify-center border-y border-r border-neutral-200 text-14 transition-all first:rounded-l-md first:border-l last:rounded-r-md dark:border-neutral-800',
        isActive &&

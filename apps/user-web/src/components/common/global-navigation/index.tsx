...
export default async function GlobalNavigation() {
  ...
  return (
    <nav className="z-999 fixed mx-auto max-w-[640px] bottom-0 left-0 right-0 flex items-center justify-evenly shadow-gnb bg-swifty-color-100 dark:bg-swifty-color-dark-bg dark:shadow-dark-gnb">

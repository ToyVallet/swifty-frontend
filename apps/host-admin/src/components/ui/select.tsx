...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex w-full items-center justify-between border border-swifty-color-300 rounded-xl bg-white px-5 py-3 text-16 font-medium ring-offset-white placeholder:text-swifty-color-300 focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:placeholder:text-swifty-color-300 dark:focus:ring-neutral-300',
      className,
    )}
    {...props}
  >
